<script setup lang="ts">
    ...
    const data = reactive<number[]>([1, 2, 3, 4, 5])

</script>

<template>
    <div @mouseenter="handleOpenCarts" @mouseleave="handleCloseCarts" class="wrapper-cart">
            <RouterLink class="action-item categories" :to="routesConfig.cat">
                <FaCart />
                    <div v-if="data.length > 0" class="count-item">
                    ...
                    <template v-if="infos.isAuth">
                        ...
                        <div class="contents">
                                <template v-if="data.length > 0">
                                    <div v-for="item in data.slice(0, 3)" key={item.carts_id} class="cart-item">
                                        <div class="preview">
                                            <img :src="logo" alt="preview images" />
                                        </div>
                        ...
                        <div class="footer-cart">
                            ...
                            <Button to={routesConfig.categories}>
                                Xem giỏ hàng
                            </Button>
                        </div>
                    </template>
